<?php
$category = isset($_GET['cat']) && is_numeric($_GET['cat'])?$_GET['cat']:0;
$search = isset($_GET['q'])?"and title like'%".$_GET['q']."%'":"";
$q = mysqli_query($conn, "select * from items where category = $category {$search}");
